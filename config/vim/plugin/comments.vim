...
"               For VIM 5 -
"               Put this file somewhere and 'source <path>/comments.vim' from '~/.vimrc'
...
" *********************************************************************************************
" Jasmeet Anand, 20th March 2008 v2.10
...
function! CommentLine()
  ...
  if file_name =~ '\.cpp$' || file_name =~ '\.hpp$' || file_name =~ '\.cc$' || file_name =~ '\.hh$' || file_name =~ '\.c$' || file_name =~ '\.h$' || file_name =~ '\.java$' || file_name =~ '\.php[2345]\?$' || file_name =~ '\.C$'
